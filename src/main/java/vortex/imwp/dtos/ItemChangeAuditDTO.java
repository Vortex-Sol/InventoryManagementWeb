...
public class ItemChangeAuditDTO {
    private Long id;
    private Long  itemId;
    ...
    public ItemChangeAuditDTO(Long id, Long itemId, Long stockerId, Long warehouseId, LocalDateTime changedAt, String dataChanged) {
        this.id = id;
        this.itemId = itemId;
